    ...
    <section className="about" id="about">
      ...
      <article className="about__resume">
        ...
        <p className="regular-text">
          ...
          is the reason why I dig more into the technology world.
        </p>
        <p className="regular-text">
      ...
      <article className="about__info">
        ...
        <div className="about__companies">
          ...
          <img
            ...
            className="about__companies--logo gestorex"
          ></img>
          <img
            src={MonoGrafica}
            alt="MonoGrafica logotype"
            className="about__companies--logo monografica"
          ></img>
        </div>
        ...
        <div className="about__companies">
          ...
          <img
            src={EASDM}
            alt="EASDM logotype"
            className="about__companies--logo easdm"
          ></img>
        </div>
      </article>
      ...
      <a
        ...
        href="./Patricia-Becerra-Corbacho-CV.pdf"
        download
      >
